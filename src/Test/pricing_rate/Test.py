...
from Pricing.Rates.Payoffs.Autocallable import Autocall,TARN
from Pricing.Rates.Payoffs.Callable import MinMax,RangeAccrual,FixedRate,Digit
...
def retrieve_data(path_data:str):
    with pd.ExcelFile(path_data) as File:
        ...
        return {"curve":df_curve,"swaption":df_swaption,"caps":df_caps,"issuer":df_issuer}
...
test=test_minmax_swap

currency=test['param']['currency']
prep_model=HullWhite.get_model(data,currency,calc_date)
