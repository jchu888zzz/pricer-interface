...
test_minmax_bond={'_source_tab':'MinMax',
                'param':{'issue_date':'30.11.2025',
                        'maturity':'5',
                        'fixing_days_offset':'-5',
                        'frequency':'Annually',
...
data_callable={'multi-call': 'true',
                'NC':'3'}
test_minmax_bond['param'].update(data_callable)

test_minmax_swap={'_source_tab':'MinMax',
                'param':{'issue_date':'30.11.2025',
                        'maturity':'5',
                        'fixing_days_offset':'-5',
                        'frequency':'Annually',
...
data_callable={'multi-call': 'true',
                'NC':'3'}
test_minmax_swap['param'].update(data_callable)