...
from PySide6.QtWidgets import (
    QWidget, QFormLayout,QHBoxLayout,QLabel,QMessageBox,QSizePolicy,QPushButton
)
...
class Ui_Tarn(QWidget):
    ...
    def setup_ui(self):
        ...
        self.guaranteed_coupon_widget=GuaranteedCouponWidget()
        layout1.addRow(self.guaranteed_coupon_widget)
    ...
    def _setup_logic(self):
        ...
        # checkbox toggles visibility Guaranteed coupons
        self.guaranteed_coupon_widget.has_guaranteedcoupon.toggled.connect(self.guaranteed_coupon_widget.stack.setCurrentIndex)
    ...
    def _validate(self) -> Union[bool, str]:
        ...
        if self.target.value() <= self.guaranteed_coupon_widget.nb_coupon.value()*self.guaranteed_coupon_widget.coupon.value():
...
class Ui_FixedRate(QWidget):
    ...
    def setup_ui(self):
        self.setAttribute(Qt.WA_StyledBackground, True)
        self.setObjectName("formFixedRate")
        layout = QHBoxLayout(self)
        layout.setContentsMargins(20, 12, 20, 12)
        layout.setSpacing(50)
